...
export default function HomePage() {
    ...
    const Add = (e) => {
        ...
        const id = uuid();
        Axios.get(
            `${process.env.REACT_APP_ADDEMPLOYEE}?fullname=${newEmployee.fullName}&address=${newEmployee.address}&phone=${newEmployee.phone}&isDelete=${isDelete}&area=${newEmployee.area}`
        )
            .then((rs) => {
