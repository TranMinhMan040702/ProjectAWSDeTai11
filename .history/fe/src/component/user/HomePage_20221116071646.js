...
export default function HomePage() {
    ...
    const Add = (e) => {
        ...
        Axios.get(
            `${process.env.REACT_APP_ADDEMPLOYEE}?nameUser=${newUser.nameUser}&email=${newUser.email}&address=${newUser.address}&phone=${newUser.phone}&isDelete=${isDelete}&username=${username}&password=${password}&area=${newUser.area}&role=user`
        )
            .then((rs) => {
