            ...
            >
              {listAreas.map((item) => {
                if (item.isDeleted == "false") {
                  return <option value={item.id}>{item.nameArea}</option>;
                }
              })}
            </select>
                          ...
                          <tr key={item.username}>
                            ...
                            <td>
                              <a
                                ...
                                onClick={(e) =>
                                  ClickPencil(item.username, item.area)
                                }
                              >
                                <i
                    ...
                    >
                      ...
                      {listAreas &&
                        listAreas.map((item) => {
                          if (item.isDeleted == "false")
                            return (
                              <option value={item.id}>{item.nameArea}</option>
                            );
                        })}
                    </select>
                  </div>
                ...
                <div class="modal-body">
                  ...
                  <div className="mb-3">
                    ...
                    <select
                      ...
                      required
                      onChange={(e) => {
                        setNewUser({ ...newUser, area: e.target.value });
                      }}
                    >
                      {listAreas.map((item) => {
                        if (item.isDeleted == "false") {
...
>>>>>>> 288f9fa556b6361b0aced7b19837127c98db7575
}
